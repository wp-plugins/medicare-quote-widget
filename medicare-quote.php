...
<div style="border:2px solid; background: #fff; width: 200px; padding:10px; border-radius:25px; box-shadow: 8px 8px 5px #888888;">
...
<p style="font-size:16px; text-align:center">Zip Code:  <input type="text" name="zip" style="width:60px; height: 10px;"></p>
...
<p style="text-align:center"><a href="http://www.ehealthmedicare.com?allid=Med35993" target="blank"><img src="/wp-content/plugins/medicare-quote-widget/ehealth-medicare-logo.gif" align="middle"></a></p>
